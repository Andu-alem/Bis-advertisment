...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="container-fluid p-1 pl-sm-4 bg-light">
          <a class="navbar-brand" href="#"><h3 style="color: #39ac73;">Wellcome To this web</h3></a>
          <!---
      ...
      <div class="container-fluid bg-dark sticky-top border-bottom s-top" style="" id="s_top">
        <div class="row">
          <div class="col-1 d-sm-none" data-toggle="modal" data-target="#sideMenuModal">
            <span class="menu-icon d-sm-none"></span>
          </div>
          <div class="col-5 col-md-5">
                <a class="pl-md-5 ml-md-5 font-weight-bold font-italic" href="index.php" style="text-decoration: underline; font-size: 2.5rem; color: #999999;">
                  <span style="color:#39ac73;">Bi</span>sAd
                </a>
            </div>
            <div class="col-5 col-md-7 w-100 pt-2 pl-1 pl-sm-3 pr-3" style=" height: 50px;">
                  <div class="pt-2" style="align-items:center; ">
        ...
        <!--
          <div class="col-12 col-md-5 cat-option" id="cat-option">
              <form class="" id = "form-slct" action="index.php" method="post">
                  <label for=""></label>
                  <select name="catid" onchange="srch()">
                      <option value="">Choose By Catagory</option>
            ...
            <input type="submit" name="catname" value="GO">
...
<!--
      <div class="container-fluid sticky-top m-0 w-100" style="background-color: #39ac73; height: 50px; width= 90%;">
        <div class="pt-2" style="align-items:center; ">
            <form class="form-row search-form" role = "form" name="form1" method="post" action="index.php">
                <input class="form-control search" type="search" name="search_value" ng-model="sear" onfocus="this.placeholder='';" onblur="this.placeholder='Search spacific place'" placeholder="Search spacific place">
                <input type="submit" class="submit-btn text-white" name="search" value="" style="background: url('img/icon-search.png') no-repeat; background-position: center;">
            </form>
        </div>
      </div>
    -->
      ...
      <div class="container-fluid position-relative" style="min-height: 500px;">
        <div class="row">
          ...
          <div class="col-12 col-xs-11 col-sm-8 col-md-7 col-lg-7 mt-3 bg-light" style="">
            <div class="row">
