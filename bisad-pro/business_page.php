...
<html lang="en" dir="ltr">
    ...
    <body>
        <div class="container-fluid row border-bottom bg-light sticky-top">
            <div class = "col-12 col-md-5">
                <a class="ml-3 font-weight-bold font-italic" href="index.php" style="text-decoration: underline; font-size: 2.5rem; color: #999999;">
                    <span style="color:#39ac73;">Bi</span>sAd
                </a>
            </div>
            <div class="col-12 col-md-7 pt-1">
                <h2 class="text-justify"><?php echo $business_name; ?></h2>
                <h4 class="font-italic text-secondary pl-2 d-none d-sm-block"><?php echo $cat_name; ?></h4>
            </div>
